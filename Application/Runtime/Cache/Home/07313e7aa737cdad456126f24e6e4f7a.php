...
<div class="weui_tab" style="background:#FFF;">
    <div class="weui_tab_bd">
        <form action="/work/pay_center/index.php/Home/direct/settlement" method="post">
            <div class="weui_tab_bd" style="margin-top:60px; margin-bottom:80px;">
                <div class="xzpp">选择品牌:
                    <select id="brand" name="brand">
                        <option value="">请选择</option>
                        <?php if(is_array($bd)): foreach($bd as $key=>$db): ?><option value="<?php echo ($db["bdid"]); ?>"><?php echo ($db["name"]); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
