    ...
    <div class="weui_tab_bd">
        <div class="weui_tab_bd" style="margin-top:60px; margin-bottom:80px;">
        	<div class="pay">
                ...
                <p class="inpay_1">
                    <?php if($tp == 1): ?>配送通宝币TBC：4950元
                        <?php elseif($tp == 2): ?>配送通宝币TBC：9900元
                        <?php elseif($tp == 3): ?>前32名配送通宝币TBC99000元
                        <?php else: ?>前8名配送通宝币TBC396000元<?php endif; ?>
                </p>
            </div>
            ...
            <form action="/work/pay_center/index.php/Home/Main/addOrder" method="post">
